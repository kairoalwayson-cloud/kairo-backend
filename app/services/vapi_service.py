...
def _build_assistant_payload(
    ...
    system_prompt = (
        ...
        f"- When confirming the number back, read each digit individually: 'seis, sete, nove, nove...'\n"
        ...
        f"4. Confirm their city/area is within service area\n"
        ...
        f"7. Once caller confirms, call book_appointment (only if you have: name, phone, address, date, time)\n"
